...
period_grid_array = [0.2,0.75,1.5,2.0,3.0,4.0,6.0,8.0,12.0,20.0,32.0,64.0,128.0,256.0,500.0] # days len=15
...
eccentricity_grid_array = [0.0,0.005,0.01,0.05,0.1,0.2,0.4,0.6,0.8,0.99] # unitless  len=12 more ecc in lower esp.
