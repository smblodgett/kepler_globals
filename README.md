...
interiors, and dynamics, with important implications for the formation and evolution of planetary systems.

### Models
This repository also contains code which calculates non-parameterized 3D histogram weights using [emcee](https://emcee.readthedocs.io/en/stable) ([Foreman-Mackey et al. 2013](https://arxiv.org/abs/1202.3665)) to model the true underlying exoplanet distribution.
